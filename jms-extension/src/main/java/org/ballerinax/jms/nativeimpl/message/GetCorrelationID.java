...
public class GetCorrelationID extends BlockingNativeCallableUnit {

    @Override
    public void execute(Context context) {
    }

    public static Object getCorrelationID(Strand strand, ObjectValue msgObj) {
        ...
        try {
            ...
            return BallerinaAdapter.getError("Error when retrieving correlation ID", e);
        }
    }
