...
package org.ballerinax.jms.nativeimpl.endpoint.queue.receiver.action;
...
public class Acknowledge extends BlockingNativeCallableUnit {
    ...
    public static Object acknowledge(Strand strand, ObjectValue queueReceiver, ObjectValue msg) {
        return MessageAcknowledgementHandler.handle(queueReceiver, msg);
    }
}
